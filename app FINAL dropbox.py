...
"Per ordenar les imatges segons la teva preferència, arrossega les etiquetes de les imatges (segona columna). Les fotografies s'aniran reordenant segons l'ordre en què les hagis classificat.")
