...
st.write("A sota tens dues columnes: la primera indica la posició del rànquing, i la segona conté les etiquetes de les imatges en vermell. Les fotografies es troben a sota d'aquestes dues columnes. "
         "Per ordenar les imatges segons la teva preferència, arrossega les etiquetes de les imatges (segona columna) a la posició corresponent. Les fotografies s'aniran reordenant segons l'ordre en què les hagis classificat.")
